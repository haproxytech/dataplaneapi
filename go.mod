...
require (
	...
	github.com/haproxytech/client-native v1.2.7-0.20200402140848-4bfd3c2074a8
	github.com/haproxytech/config-parser/v2 v2.0.0-rc2.0.20200330144517-5cf21c7b3a77
