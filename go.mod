...
require (
	...
	github.com/haproxytech/client-native/v2 v2.2.1-0.20210211083830-1fa0bdfff352
	github.com/haproxytech/config-parser/v3 v3.0.1-0.20210211082917-673a2faa353b
