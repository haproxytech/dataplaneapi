...
require (
	...
	github.com/haproxytech/client-native/v3 v3.1.1-0.20220701122745-368574f6b93c
	github.com/haproxytech/config-parser/v4 v4.0.0-rc2.0.20220701080617-390b5bef9d65
