...
require (
	...
	github.com/haproxytech/client-native/v2 v2.5.2-0.20220123094434-cfca624a4efc
	github.com/haproxytech/config-parser/v4 v4.0.0-rc2.0.20220122194318-83cd11810f95
