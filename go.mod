...
require (
	...
	github.com/haproxytech/client-native/v4 v4.0.1-0.20221003084326-7778838bab94
	github.com/haproxytech/config-parser/v4 v4.0.0-rc4.0.20220929131913-6f2ba1604532
