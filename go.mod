...
require (
	...
	github.com/haproxytech/client-native/v3 v3.0.0-rc1.0.20220128101758-8d8dfd3ebe87
	github.com/haproxytech/config-parser/v4 v4.0.0-rc2.0.20220126135717-1dd35f8b7a52
