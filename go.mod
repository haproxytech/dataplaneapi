...
require (
	...
	github.com/haproxytech/client-native/v3 v3.1.1-0.20220630075317-620c4c931c20
	github.com/haproxytech/config-parser/v4 v4.0.0-rc2.0.20220629111926-403e1b3db8a2
