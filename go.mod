...
require (
	...
	github.com/haproxytech/client-native/v3 v3.1.1-0.20220630145315-3c89ecd80819
	github.com/haproxytech/config-parser/v4 v4.0.0-rc2.0.20220630082923-08f290ebcecc
