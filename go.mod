...
require (
	...
	github.com/haproxytech/client-native/v6 v6.0.0-20240404115818-cc6709fcf3f2
	github.com/haproxytech/config-parser/v5 v5.1.1-0.20240404084124-95ffb3171d4e
