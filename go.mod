...
require (
	...
	github.com/haproxytech/client-native/v3 v3.1.1-0.20220701144948-9ded37d62818
	github.com/haproxytech/config-parser/v4 v4.0.0-rc2.0.20220701135750-24c4f79527ba
