...
require (
	...
	github.com/haproxytech/client-native/v4 v4.0.1-0.20221003143956-374606ec4378
	github.com/haproxytech/config-parser/v4 v4.0.0-rc4.0.20221003072920-214c63f7fd83
