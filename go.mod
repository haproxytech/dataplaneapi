...
require (
	...
	github.com/haproxytech/client-native/v2 v2.5.2-0.20220123180920-564640cff542
	github.com/haproxytech/config-parser/v4 v4.0.0-rc2.0.20220123165431-e8956e74adb2
