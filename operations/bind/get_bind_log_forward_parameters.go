...
func NewGetBindLogForwardParams() GetBindLogForwardParams {

	return GetBindLogForwardParams{}
}
...
//
// To ensure default values, the struct must have been initialized with NewGetBindLogForwardParams() beforehand.
func (o *GetBindLogForwardParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetBindLogForwardParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetBindLogForwardParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetBindLogForwardParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetBindLogForwardParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
