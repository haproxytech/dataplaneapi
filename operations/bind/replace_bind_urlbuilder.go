...
func (o *ReplaceBindURL) Build() (*url.URL, error) {
	...
	if name != "" {
		...
		return nil, errors.New("name is required on ReplaceBindURL")
	}
...
func (o *ReplaceBindURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ReplaceBindURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ReplaceBindURL")
	}
