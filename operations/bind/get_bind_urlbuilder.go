...
func (o *GetBindURL) Build() (*url.URL, error) {
	...
	if name != "" {
		...
		return nil, errors.New("name is required on GetBindURL")
	}
...
func (o *GetBindURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetBindURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetBindURL")
	}
