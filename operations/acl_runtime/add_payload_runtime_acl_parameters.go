...
// AddPayloadRuntimeACLParams contains all the bound params for the add payload runtime ACL operation
// typically these are obtained from a http.Request
//
// swagger:parameters addPayloadRuntimeACL
...
//
// To ensure default values, the struct must have been initialized with NewAddPayloadRuntimeACLParams() beforehand.
func (o *AddPayloadRuntimeACLParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *AddPayloadRuntimeACLParams) validateParentName(formats strfmt.Registry) error {
