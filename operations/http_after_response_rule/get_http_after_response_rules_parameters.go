...
// GetHTTPAfterResponseRulesParams contains all the bound params for the get HTTP after response rules operation
// typically these are obtained from a http.Request
//
// swagger:parameters getHTTPAfterResponseRules
...
//
// To ensure default values, the struct must have been initialized with NewGetHTTPAfterResponseRulesParams() beforehand.
func (o *GetHTTPAfterResponseRulesParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetHTTPAfterResponseRulesParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetHTTPAfterResponseRulesParams) bindParentType(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetHTTPAfterResponseRulesParams) validateParentType(formats strfmt.Registry) error {
...
func (o *GetHTTPAfterResponseRulesParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
