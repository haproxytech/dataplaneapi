...
// CreateHTTPAfterResponseRuleParams contains all the bound params for the create HTTP after response rule operation
// typically these are obtained from a http.Request
//
// swagger:parameters createHTTPAfterResponseRule
...
//
// To ensure default values, the struct must have been initialized with NewCreateHTTPAfterResponseRuleParams() beforehand.
func (o *CreateHTTPAfterResponseRuleParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *CreateHTTPAfterResponseRuleParams) bindForceReload(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewCreateHTTPAfterResponseRuleParams()
		return nil
	}
...
func (o *CreateHTTPAfterResponseRuleParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateHTTPAfterResponseRuleParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *CreateHTTPAfterResponseRuleParams) bindParentType(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *CreateHTTPAfterResponseRuleParams) validateParentType(formats strfmt.Registry) error {
...
func (o *CreateHTTPAfterResponseRuleParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateHTTPAfterResponseRuleParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
