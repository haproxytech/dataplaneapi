...
func NewGetHTTPAfterResponseRuleBackendParams() GetHTTPAfterResponseRuleBackendParams {

	return GetHTTPAfterResponseRuleBackendParams{}
}

// GetHTTPAfterResponseRuleBackendParams contains all the bound params for the get HTTP after response rule backend operation
...
//
// To ensure default values, the struct must have been initialized with NewGetHTTPAfterResponseRuleBackendParams() beforehand.
func (o *GetHTTPAfterResponseRuleBackendParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetHTTPAfterResponseRuleBackendParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetHTTPAfterResponseRuleBackendParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetHTTPAfterResponseRuleBackendParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetHTTPAfterResponseRuleBackendParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
