...
func NewGetHTTPAfterResponseRuleFrontendParams() GetHTTPAfterResponseRuleFrontendParams {

	return GetHTTPAfterResponseRuleFrontendParams{}
}

// GetHTTPAfterResponseRuleFrontendParams contains all the bound params for the get HTTP after response rule frontend operation
...
//
// To ensure default values, the struct must have been initialized with NewGetHTTPAfterResponseRuleFrontendParams() beforehand.
func (o *GetHTTPAfterResponseRuleFrontendParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetHTTPAfterResponseRuleFrontendParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetHTTPAfterResponseRuleFrontendParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetHTTPAfterResponseRuleFrontendParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetHTTPAfterResponseRuleFrontendParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
