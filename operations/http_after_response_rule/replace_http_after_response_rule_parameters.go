...
// ReplaceHTTPAfterResponseRuleParams contains all the bound params for the replace HTTP after response rule operation
// typically these are obtained from a http.Request
//
// swagger:parameters replaceHTTPAfterResponseRule
...
//
// To ensure default values, the struct must have been initialized with NewReplaceHTTPAfterResponseRuleParams() beforehand.
func (o *ReplaceHTTPAfterResponseRuleParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ReplaceHTTPAfterResponseRuleParams) bindForceReload(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewReplaceHTTPAfterResponseRuleParams()
		return nil
	}
...
func (o *ReplaceHTTPAfterResponseRuleParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceHTTPAfterResponseRuleParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *ReplaceHTTPAfterResponseRuleParams) bindParentType(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *ReplaceHTTPAfterResponseRuleParams) validateParentType(formats strfmt.Registry) error {
...
func (o *ReplaceHTTPAfterResponseRuleParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceHTTPAfterResponseRuleParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
