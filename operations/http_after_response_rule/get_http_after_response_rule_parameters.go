...
// GetHTTPAfterResponseRuleParams contains all the bound params for the get HTTP after response rule operation
// typically these are obtained from a http.Request
//
// swagger:parameters getHTTPAfterResponseRule
...
//
// To ensure default values, the struct must have been initialized with NewGetHTTPAfterResponseRuleParams() beforehand.
func (o *GetHTTPAfterResponseRuleParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetHTTPAfterResponseRuleParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetHTTPAfterResponseRuleParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetHTTPAfterResponseRuleParams) bindParentType(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetHTTPAfterResponseRuleParams) validateParentType(formats strfmt.Registry) error {
...
func (o *GetHTTPAfterResponseRuleParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
