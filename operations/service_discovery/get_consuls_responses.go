...
func (o *GetConsulsDefault) WithConfigurationVersion(configurationVersion int64) *GetConsulsDefault {
	o.ConfigurationVersion = configurationVersion
	return o
}

// SetConfigurationVersion sets the configurationVersion to the get consuls default response
func (o *GetConsulsDefault) SetConfigurationVersion(configurationVersion int64) {
	o.ConfigurationVersion = configurationVersion
}
