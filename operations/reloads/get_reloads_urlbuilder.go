...
func (o *GetReloadsURL) Build() (*url.URL, error) {
	...
	var _path = "/services/haproxy/reloads"
...
func (o *GetReloadsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetReloadsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetReloadsURL")
	}
