...
// CommitSpoeTransactionParams contains all the bound params for the commit spoe transaction operation
...
//
// To ensure default values, the struct must have been initialized with NewCommitSpoeTransactionParams() beforehand.
func (o *CommitSpoeTransactionParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *CommitSpoeTransactionParams) bindForceReload(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CommitSpoeTransactionParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CommitSpoeTransactionParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CommitSpoeTransactionParams) validateParentName(formats strfmt.Registry) error {
