...
func (o *DeleteFilterURL) Build() (*url.URL, error) {
	...
	if index != "" {
		...
		return nil, errors.New("index is required on DeleteFilterURL")
	}
...
func (o *DeleteFilterURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteFilterURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteFilterURL")
	}
