...
// GetFilterParams contains all the bound params for the get filter operation
...
func (o *GetFilterParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
