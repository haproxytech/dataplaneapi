...
// NewReplaceFiltersParams creates a new ReplaceFiltersParams object
// with the default values initialized.
func NewReplaceFiltersParams() ReplaceFiltersParams {
	...
	return ReplaceFiltersParams{
		ForceReload: &forceReloadDefault,
	}
}

// ReplaceFiltersParams contains all the bound params for the replace filters operation
// typically these are obtained from a http.Request
//
// swagger:parameters replaceFilters
type ReplaceFiltersParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewReplaceFiltersParams() beforehand.
func (o *ReplaceFiltersParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ReplaceFiltersParams) bindForceReload(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewReplaceFiltersParams()
		return nil
	}
...
func (o *ReplaceFiltersParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *ReplaceFiltersParams) bindParentType(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *ReplaceFiltersParams) validateParentType(formats strfmt.Registry) error {
...
func (o *ReplaceFiltersParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceFiltersParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
