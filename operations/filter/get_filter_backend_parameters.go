...
func NewGetFilterBackendParams() GetFilterBackendParams {

	return GetFilterBackendParams{}
}

// GetFilterBackendParams contains all the bound params for the get filter backend operation
...
//
// To ensure default values, the struct must have been initialized with NewGetFilterBackendParams() beforehand.
func (o *GetFilterBackendParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetFilterBackendParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetFilterBackendParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetFilterBackendParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetFilterBackendParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
