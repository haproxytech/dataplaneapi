...
func (o *CreateFilterURL) Build() (*url.URL, error) {
	...
	if index != "" {
		...
		return nil, errors.New("index is required on CreateFilterURL")
	}
...
func (o *CreateFilterURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateFilterURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateFilterURL")
	}
