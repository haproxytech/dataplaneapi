...
// GetNameserversParams contains all the bound params for the get nameservers operation
// typically these are obtained from a http.Request
//
// swagger:parameters getNameservers
...
//
// To ensure default values, the struct must have been initialized with NewGetNameserversParams() beforehand.
func (o *GetNameserversParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetNameserversParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
