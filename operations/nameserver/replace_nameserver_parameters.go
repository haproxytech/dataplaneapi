...
// ReplaceNameserverParams contains all the bound params for the replace nameserver operation
// typically these are obtained from a http.Request
//
// swagger:parameters replaceNameserver
...
//
// To ensure default values, the struct must have been initialized with NewReplaceNameserverParams() beforehand.
func (o *ReplaceNameserverParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	qResolver, qhkResolver, _ := qs.GetOK("resolver")
	if err := o.bindResolver(qResolver, qhkResolver, route.Formats); err != nil {
		res = append(res, err)
	}
...
func (o *ReplaceNameserverParams) bindForceReload(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewReplaceNameserverParams()
		return nil
	}
...
func (o *ReplaceNameserverParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceNameserverParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceNameserverParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
