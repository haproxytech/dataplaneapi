...
type ReplaceNameserverHandlerFunc func(ReplaceNameserverParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceNameserverHandlerFunc) Handle(params ReplaceNameserverParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// ReplaceNameserverHandler interface for that can handle valid replace nameserver params
type ReplaceNameserverHandler interface {
	Handle(ReplaceNameserverParams, interface{}) middleware.Responder
}

// NewReplaceNameserver creates a new http.Handler for the replace nameserver operation
func NewReplaceNameserver(ctx *middleware.Context, handler ReplaceNameserverHandler) *ReplaceNameserver {
...
type ReplaceNameserver struct {
	...
	Handler ReplaceNameserverHandler
}
