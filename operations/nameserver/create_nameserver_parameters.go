...
// CreateNameserverParams contains all the bound params for the create nameserver operation
// typically these are obtained from a http.Request
//
// swagger:parameters createNameserver
...
//
// To ensure default values, the struct must have been initialized with NewCreateNameserverParams() beforehand.
func (o *CreateNameserverParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *CreateNameserverParams) bindForceReload(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewCreateNameserverParams()
		return nil
	}
...
func (o *CreateNameserverParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateNameserverParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
