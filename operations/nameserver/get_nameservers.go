...
type GetNameserversHandlerFunc func(GetNameserversParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetNameserversHandlerFunc) Handle(params GetNameserversParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// GetNameserversHandler interface for that can handle valid get nameservers params
type GetNameserversHandler interface {
	Handle(GetNameserversParams, interface{}) middleware.Responder
}

// NewGetNameservers creates a new http.Handler for the get nameservers operation
func NewGetNameservers(ctx *middleware.Context, handler GetNameserversHandler) *GetNameservers {
