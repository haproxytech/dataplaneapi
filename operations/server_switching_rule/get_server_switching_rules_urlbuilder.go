...
func (o *GetServerSwitchingRulesURL) WithBasePath(bp string) *GetServerSwitchingRulesURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetServerSwitchingRulesURL) Build() (*url.URL, error) {
	...
	if parentName != "" {
		...
		return nil, errors.New("parentName is required on GetServerSwitchingRulesURL")
	}
...
func (o *GetServerSwitchingRulesURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetServerSwitchingRulesURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetServerSwitchingRulesURL")
	}
