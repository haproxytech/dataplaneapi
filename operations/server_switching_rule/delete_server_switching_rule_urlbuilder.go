...
func (o *DeleteServerSwitchingRuleURL) WithBasePath(bp string) *DeleteServerSwitchingRuleURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteServerSwitchingRuleURL) Build() (*url.URL, error) {
	...
	if index != "" {
		...
		return nil, errors.New("index is required on DeleteServerSwitchingRuleURL")
	}
	...
	if parentName != "" {
		...
		return nil, errors.New("parentName is required on DeleteServerSwitchingRuleURL")
	}
...
func (o *DeleteServerSwitchingRuleURL) String() string {
...
func (o *DeleteServerSwitchingRuleURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteServerSwitchingRuleURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteServerSwitchingRuleURL")
	}
