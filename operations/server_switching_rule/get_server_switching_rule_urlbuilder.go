...
func (o *GetServerSwitchingRuleURL) WithBasePath(bp string) *GetServerSwitchingRuleURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetServerSwitchingRuleURL) Build() (*url.URL, error) {
	...
	if parentName != "" {
		...
		return nil, errors.New("parentName is required on GetServerSwitchingRuleURL")
	}
...
func (o *GetServerSwitchingRuleURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetServerSwitchingRuleURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetServerSwitchingRuleURL")
	}
