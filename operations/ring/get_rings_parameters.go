...
// GetRingsParams contains all the bound params for the get rings operation
...
//
// To ensure default values, the struct must have been initialized with NewGetRingsParams() beforehand.
func (o *GetRingsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetRingsParams) bindFullSection(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewGetRingsParams()
		return nil
	}
...
func (o *GetRingsParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
