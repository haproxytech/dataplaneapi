...
func (o *GetHaproxyProcessInfoURL) Build() (*url.URL, error) {
	...
	var _path = "/services/haproxy/runtime/info"
...
func (o *GetHaproxyProcessInfoURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetHaproxyProcessInfoURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetHaproxyProcessInfoURL")
	}
