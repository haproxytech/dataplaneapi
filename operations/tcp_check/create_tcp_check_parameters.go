...
// CreateTCPCheckParams contains all the bound params for the create TCP check operation
// typically these are obtained from a http.Request
//
// swagger:parameters createTCPCheck
...
//
// To ensure default values, the struct must have been initialized with NewCreateTCPCheckParams() beforehand.
func (o *CreateTCPCheckParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *CreateTCPCheckParams) bindForceReload(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewCreateTCPCheckParams()
		return nil
	}
...
func (o *CreateTCPCheckParams) bindParentType(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *CreateTCPCheckParams) validateParentType(formats strfmt.Registry) error {
...
func (o *CreateTCPCheckParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateTCPCheckParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
