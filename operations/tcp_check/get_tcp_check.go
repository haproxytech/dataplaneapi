...
type GetTCPCheckHandlerFunc func(GetTCPCheckParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetTCPCheckHandlerFunc) Handle(params GetTCPCheckParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// GetTCPCheckHandler interface for that can handle valid get TCP check params
type GetTCPCheckHandler interface {
	Handle(GetTCPCheckParams, interface{}) middleware.Responder
}

// NewGetTCPCheck creates a new http.Handler for the get TCP check operation
func NewGetTCPCheck(ctx *middleware.Context, handler GetTCPCheckHandler) *GetTCPCheck {
...
type GetTCPCheck struct {
	...
	Handler GetTCPCheckHandler
}

func (o *GetTCPCheck) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	route, rCtx, _ := o.Context.RouteInfo(r)
	if rCtx != nil {
		*r = *rCtx
	}
	var Params = NewGetTCPCheckParams()
