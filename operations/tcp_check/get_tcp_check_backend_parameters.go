...
func NewGetTCPCheckBackendParams() GetTCPCheckBackendParams {

	return GetTCPCheckBackendParams{}
}

// GetTCPCheckBackendParams contains all the bound params for the get TCP check backend operation
...
//
// To ensure default values, the struct must have been initialized with NewGetTCPCheckBackendParams() beforehand.
func (o *GetTCPCheckBackendParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetTCPCheckBackendParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetTCPCheckBackendParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetTCPCheckBackendParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetTCPCheckBackendParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
