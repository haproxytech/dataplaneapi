...
// GetTCPCheckParams contains all the bound params for the get TCP check operation
// typically these are obtained from a http.Request
//
// swagger:parameters getTCPCheck
...
//
// To ensure default values, the struct must have been initialized with NewGetTCPCheckParams() beforehand.
func (o *GetTCPCheckParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetTCPCheckParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetTCPCheckParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetTCPCheckParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
