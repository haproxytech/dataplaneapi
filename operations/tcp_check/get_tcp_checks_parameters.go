...
// GetTCPChecksParams contains all the bound params for the get TCP checks operation
// typically these are obtained from a http.Request
//
// swagger:parameters getTCPChecks
...
//
// To ensure default values, the struct must have been initialized with NewGetTCPChecksParams() beforehand.
func (o *GetTCPChecksParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetTCPChecksParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetTCPChecksParams) bindParentType(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetTCPChecksParams) validateParentType(formats strfmt.Registry) error {
...
func (o *GetTCPChecksParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
