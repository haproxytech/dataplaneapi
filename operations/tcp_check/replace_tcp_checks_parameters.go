...
// NewReplaceTCPChecksParams creates a new ReplaceTCPChecksParams object
// with the default values initialized.
func NewReplaceTCPChecksParams() ReplaceTCPChecksParams {
	...
	return ReplaceTCPChecksParams{
		ForceReload: &forceReloadDefault,
	}
}

// ReplaceTCPChecksParams contains all the bound params for the replace TCP checks operation
// typically these are obtained from a http.Request
//
// swagger:parameters replaceTCPChecks
type ReplaceTCPChecksParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewReplaceTCPChecksParams() beforehand.
func (o *ReplaceTCPChecksParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ReplaceTCPChecksParams) bindForceReload(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewReplaceTCPChecksParams()
		return nil
	}
...
func (o *ReplaceTCPChecksParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *ReplaceTCPChecksParams) bindParentType(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *ReplaceTCPChecksParams) validateParentType(formats strfmt.Registry) error {
...
func (o *ReplaceTCPChecksParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceTCPChecksParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
