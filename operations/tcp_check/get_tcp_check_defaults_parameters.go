...
func NewGetTCPCheckDefaultsParams() GetTCPCheckDefaultsParams {

	return GetTCPCheckDefaultsParams{}
}

// GetTCPCheckDefaultsParams contains all the bound params for the get TCP check defaults operation
...
//
// To ensure default values, the struct must have been initialized with NewGetTCPCheckDefaultsParams() beforehand.
func (o *GetTCPCheckDefaultsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetTCPCheckDefaultsParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetTCPCheckDefaultsParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetTCPCheckDefaultsParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetTCPCheckDefaultsParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
