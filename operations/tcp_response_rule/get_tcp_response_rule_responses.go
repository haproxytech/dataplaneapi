...
type GetTCPResponseRuleOK struct {
	...
	/*
	  In: Body
	*/
	Payload *models.GetTCPResponseRuleOKBody `json:"body,omitempty"`
}
...
func (o *GetTCPResponseRuleOK) WithPayload(payload *models.GetTCPResponseRuleOKBody) *GetTCPResponseRuleOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get Tcp response rule o k response
func (o *GetTCPResponseRuleOK) SetPayload(payload *models.GetTCPResponseRuleOKBody) {
	o.Payload = payload
}
