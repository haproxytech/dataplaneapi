...
func (o *CreateTCPResponseRuleURL) WithBasePath(bp string) *CreateTCPResponseRuleURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *CreateTCPResponseRuleURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateTCPResponseRuleURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateTCPResponseRuleURL")
	}
