...
func (o *GetTCPResponseRulesURL) WithBasePath(bp string) *GetTCPResponseRulesURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetTCPResponseRulesURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetTCPResponseRulesURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetTCPResponseRulesURL")
	}
