...
func (o *DeleteTCPResponseRuleURL) WithBasePath(bp string) *DeleteTCPResponseRuleURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteTCPResponseRuleURL) Build() (*url.URL, error) {
	...
	if id != "" {
		...
		return nil, errors.New("id is required on DeleteTCPResponseRuleURL")
	}
...
func (o *DeleteTCPResponseRuleURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteTCPResponseRuleURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteTCPResponseRuleURL")
	}
