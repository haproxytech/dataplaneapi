...
func (o *ReplaceTCPResponseRuleURL) WithBasePath(bp string) *ReplaceTCPResponseRuleURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ReplaceTCPResponseRuleURL) Build() (*url.URL, error) {
	...
	var _path = "/services/haproxy/configuration/tcp_response_rules/{id}"

	id := swag.FormatInt64(o.ID)
	if id != "" {
		_path = strings.Replace(_path, "{id}", id, -1)
	} else {
		return nil, errors.New("id is required on ReplaceTCPResponseRuleURL")
	}
...
func (o *ReplaceTCPResponseRuleURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ReplaceTCPResponseRuleURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ReplaceTCPResponseRuleURL")
	}
