...
func (o *DeleteCrtLoadURL) WithBasePath(bp string) *DeleteCrtLoadURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *DeleteCrtLoadURL) SetBasePath(bp string) {
	o._basePath = bp
}
...
func (o *DeleteCrtLoadURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *DeleteCrtLoadURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *DeleteCrtLoadURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteCrtLoadURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteCrtLoadURL")
	}
...
func (o *DeleteCrtLoadURL) StringFull(scheme, host string) string {
