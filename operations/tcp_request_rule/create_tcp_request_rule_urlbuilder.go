...
func (o *CreateTCPRequestRuleURL) WithBasePath(bp string) *CreateTCPRequestRuleURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *CreateTCPRequestRuleURL) Build() (*url.URL, error) {
	...
	if index != "" {
		...
		return nil, errors.New("index is required on CreateTCPRequestRuleURL")
	}
...
func (o *CreateTCPRequestRuleURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateTCPRequestRuleURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateTCPRequestRuleURL")
	}
