...
func NewGetTCPRequestRuleBackendParams() GetTCPRequestRuleBackendParams {

	return GetTCPRequestRuleBackendParams{}
}

// GetTCPRequestRuleBackendParams contains all the bound params for the get TCP request rule backend operation
...
//
// To ensure default values, the struct must have been initialized with NewGetTCPRequestRuleBackendParams() beforehand.
func (o *GetTCPRequestRuleBackendParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetTCPRequestRuleBackendParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetTCPRequestRuleBackendParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetTCPRequestRuleBackendParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetTCPRequestRuleBackendParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
