...
// DeleteTCPRequestRuleParams contains all the bound params for the delete TCP request rule operation
...
func (o *DeleteTCPRequestRuleParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DeleteTCPRequestRuleParams) bindForceReload(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewDeleteTCPRequestRuleParams()
		return nil
	}
...
func (o *DeleteTCPRequestRuleParams) validateParentType(formats strfmt.Registry) error {
...
func (o *DeleteTCPRequestRuleParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteTCPRequestRuleParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
