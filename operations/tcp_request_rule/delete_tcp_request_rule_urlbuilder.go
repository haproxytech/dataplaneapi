...
func (o *DeleteTCPRequestRuleURL) WithBasePath(bp string) *DeleteTCPRequestRuleURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteTCPRequestRuleURL) Build() (*url.URL, error) {
	...
	if index != "" {
		...
		return nil, errors.New("index is required on DeleteTCPRequestRuleURL")
	}
...
func (o *DeleteTCPRequestRuleURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteTCPRequestRuleURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteTCPRequestRuleURL")
	}
