...
func NewGetTCPRequestRuleFrontendParams() GetTCPRequestRuleFrontendParams {

	return GetTCPRequestRuleFrontendParams{}
}

// GetTCPRequestRuleFrontendParams contains all the bound params for the get TCP request rule frontend operation
...
//
// To ensure default values, the struct must have been initialized with NewGetTCPRequestRuleFrontendParams() beforehand.
func (o *GetTCPRequestRuleFrontendParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetTCPRequestRuleFrontendParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetTCPRequestRuleFrontendParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetTCPRequestRuleFrontendParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetTCPRequestRuleFrontendParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
