...
// NewCreateACLBackendParams creates a new CreateACLBackendParams object
// with the default values initialized.
func NewCreateACLBackendParams() CreateACLBackendParams {
	...
	return CreateACLBackendParams{
		ForceReload: &forceReloadDefault,
	}
}

// CreateACLBackendParams contains all the bound params for the create Acl backend operation
...
//
// To ensure default values, the struct must have been initialized with NewCreateACLBackendParams() beforehand.
func (o *CreateACLBackendParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *CreateACLBackendParams) bindForceReload(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewCreateACLBackendParams()
		return nil
	}
...
func (o *CreateACLBackendParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateACLBackendParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateACLBackendParams) validateParentName(formats strfmt.Registry) error {
...
func (o *CreateACLBackendParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateACLBackendParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
