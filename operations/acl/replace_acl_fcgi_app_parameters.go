...
// NewReplaceACLFCGIAppParams creates a new ReplaceACLFCGIAppParams object
// with the default values initialized.
func NewReplaceACLFCGIAppParams() ReplaceACLFCGIAppParams {
	...
	return ReplaceACLFCGIAppParams{
		ForceReload: &forceReloadDefault,
	}
}

// ReplaceACLFCGIAppParams contains all the bound params for the replace Acl FCGI app operation
...
//
// To ensure default values, the struct must have been initialized with NewReplaceACLFCGIAppParams() beforehand.
func (o *ReplaceACLFCGIAppParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ReplaceACLFCGIAppParams) bindForceReload(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewReplaceACLFCGIAppParams()
		return nil
	}
...
func (o *ReplaceACLFCGIAppParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceACLFCGIAppParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceACLFCGIAppParams) validateParentName(formats strfmt.Registry) error {
...
func (o *ReplaceACLFCGIAppParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceACLFCGIAppParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
