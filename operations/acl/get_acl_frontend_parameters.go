...
func NewGetACLFrontendParams() GetACLFrontendParams {

	return GetACLFrontendParams{}
}

// GetACLFrontendParams contains all the bound params for the get Acl frontend operation
...
//
// To ensure default values, the struct must have been initialized with NewGetACLFrontendParams() beforehand.
func (o *GetACLFrontendParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetACLFrontendParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetACLFrontendParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetACLFrontendParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetACLFrontendParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
