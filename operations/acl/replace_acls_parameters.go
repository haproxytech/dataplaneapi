...
// NewReplaceAclsParams creates a new ReplaceAclsParams object
// with the default values initialized.
func NewReplaceAclsParams() ReplaceAclsParams {
	...
	return ReplaceAclsParams{
		ForceReload: &forceReloadDefault,
	}
}

// ReplaceAclsParams contains all the bound params for the replace acls operation
// typically these are obtained from a http.Request
//
// swagger:parameters replaceAcls
type ReplaceAclsParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewReplaceAclsParams() beforehand.
func (o *ReplaceAclsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ReplaceAclsParams) bindForceReload(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewReplaceAclsParams()
		return nil
	}
...
func (o *ReplaceAclsParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *ReplaceAclsParams) bindParentType(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *ReplaceAclsParams) validateParentType(formats strfmt.Registry) error {
...
func (o *ReplaceAclsParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceAclsParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
