...
// NewCreateACLFCGIAppParams creates a new CreateACLFCGIAppParams object
// with the default values initialized.
func NewCreateACLFCGIAppParams() CreateACLFCGIAppParams {
	...
	return CreateACLFCGIAppParams{
		ForceReload: &forceReloadDefault,
	}
}

// CreateACLFCGIAppParams contains all the bound params for the create Acl FCGI app operation
...
//
// To ensure default values, the struct must have been initialized with NewCreateACLFCGIAppParams() beforehand.
func (o *CreateACLFCGIAppParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *CreateACLFCGIAppParams) bindForceReload(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewCreateACLFCGIAppParams()
		return nil
	}
...
func (o *CreateACLFCGIAppParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateACLFCGIAppParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateACLFCGIAppParams) validateParentName(formats strfmt.Registry) error {
...
func (o *CreateACLFCGIAppParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateACLFCGIAppParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
