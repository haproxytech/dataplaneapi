...
// GetACLParams contains all the bound params for the get Acl operation
...
func (o *GetACLParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetACLParams) validateParentType(formats strfmt.Registry) error {
...
func (o *GetACLParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
