...
// NewCreateACLFrontendParams creates a new CreateACLFrontendParams object
// with the default values initialized.
func NewCreateACLFrontendParams() CreateACLFrontendParams {
	...
	return CreateACLFrontendParams{
		ForceReload: &forceReloadDefault,
	}
}

// CreateACLFrontendParams contains all the bound params for the create Acl frontend operation
...
//
// To ensure default values, the struct must have been initialized with NewCreateACLFrontendParams() beforehand.
func (o *CreateACLFrontendParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *CreateACLFrontendParams) bindForceReload(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewCreateACLFrontendParams()
		return nil
	}
...
func (o *CreateACLFrontendParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateACLFrontendParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateACLFrontendParams) validateParentName(formats strfmt.Registry) error {
...
func (o *CreateACLFrontendParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateACLFrontendParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
