...
func NewGetAllACLFCGIAppParams() GetAllACLFCGIAppParams {

	return GetAllACLFCGIAppParams{}
}

// GetAllACLFCGIAppParams contains all the bound params for the get all Acl FCGI app operation
...
//
// To ensure default values, the struct must have been initialized with NewGetAllACLFCGIAppParams() beforehand.
func (o *GetAllACLFCGIAppParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetAllACLFCGIAppParams) bindACLName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetAllACLFCGIAppParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAllACLFCGIAppParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetAllACLFCGIAppParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
