...
// NewReplaceACLBackendParams creates a new ReplaceACLBackendParams object
// with the default values initialized.
func NewReplaceACLBackendParams() ReplaceACLBackendParams {
	...
	return ReplaceACLBackendParams{
		ForceReload: &forceReloadDefault,
	}
}

// ReplaceACLBackendParams contains all the bound params for the replace Acl backend operation
...
//
// To ensure default values, the struct must have been initialized with NewReplaceACLBackendParams() beforehand.
func (o *ReplaceACLBackendParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ReplaceACLBackendParams) bindForceReload(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewReplaceACLBackendParams()
		return nil
	}
...
func (o *ReplaceACLBackendParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceACLBackendParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceACLBackendParams) validateParentName(formats strfmt.Registry) error {
...
func (o *ReplaceACLBackendParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceACLBackendParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
