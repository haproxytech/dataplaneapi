...
// NewDeleteACLBackendParams creates a new DeleteACLBackendParams object
// with the default values initialized.
func NewDeleteACLBackendParams() DeleteACLBackendParams {
	...
	return DeleteACLBackendParams{
		ForceReload: &forceReloadDefault,
	}
}

// DeleteACLBackendParams contains all the bound params for the delete Acl backend operation
...
//
// To ensure default values, the struct must have been initialized with NewDeleteACLBackendParams() beforehand.
func (o *DeleteACLBackendParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DeleteACLBackendParams) bindForceReload(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewDeleteACLBackendParams()
		return nil
	}
...
func (o *DeleteACLBackendParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteACLBackendParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteACLBackendParams) validateParentName(formats strfmt.Registry) error {
...
func (o *DeleteACLBackendParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteACLBackendParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
