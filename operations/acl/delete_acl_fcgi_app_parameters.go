...
// NewDeleteACLFCGIAppParams creates a new DeleteACLFCGIAppParams object
// with the default values initialized.
func NewDeleteACLFCGIAppParams() DeleteACLFCGIAppParams {
	...
	return DeleteACLFCGIAppParams{
		ForceReload: &forceReloadDefault,
	}
}

// DeleteACLFCGIAppParams contains all the bound params for the delete Acl FCGI app operation
...
//
// To ensure default values, the struct must have been initialized with NewDeleteACLFCGIAppParams() beforehand.
func (o *DeleteACLFCGIAppParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DeleteACLFCGIAppParams) bindForceReload(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewDeleteACLFCGIAppParams()
		return nil
	}
...
func (o *DeleteACLFCGIAppParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteACLFCGIAppParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteACLFCGIAppParams) validateParentName(formats strfmt.Registry) error {
...
func (o *DeleteACLFCGIAppParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteACLFCGIAppParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
