...
func NewGetAllACLFrontendParams() GetAllACLFrontendParams {

	return GetAllACLFrontendParams{}
}

// GetAllACLFrontendParams contains all the bound params for the get all Acl frontend operation
...
//
// To ensure default values, the struct must have been initialized with NewGetAllACLFrontendParams() beforehand.
func (o *GetAllACLFrontendParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetAllACLFrontendParams) bindACLName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetAllACLFrontendParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetAllACLFrontendParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetAllACLFrontendParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
