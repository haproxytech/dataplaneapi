...
func NewGetACLFCGIAppParams() GetACLFCGIAppParams {

	return GetACLFCGIAppParams{}
}

// GetACLFCGIAppParams contains all the bound params for the get Acl FCGI app operation
...
//
// To ensure default values, the struct must have been initialized with NewGetACLFCGIAppParams() beforehand.
func (o *GetACLFCGIAppParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetACLFCGIAppParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetACLFCGIAppParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetACLFCGIAppParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetACLFCGIAppParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
