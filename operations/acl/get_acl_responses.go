...
type GetACLOK struct {
	...
	/*
	  In: Body
	*/
	Payload *models.GetACLOKBody `json:"body,omitempty"`
}
...
func (o *GetACLOK) WithPayload(payload *models.GetACLOKBody) *GetACLOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get Acl o k response
func (o *GetACLOK) SetPayload(payload *models.GetACLOKBody) {
	o.Payload = payload
}
