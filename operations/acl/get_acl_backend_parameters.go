...
func NewGetACLBackendParams() GetACLBackendParams {

	return GetACLBackendParams{}
}

// GetACLBackendParams contains all the bound params for the get Acl backend operation
...
//
// To ensure default values, the struct must have been initialized with NewGetACLBackendParams() beforehand.
func (o *GetACLBackendParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetACLBackendParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetACLBackendParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetACLBackendParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetACLBackendParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
