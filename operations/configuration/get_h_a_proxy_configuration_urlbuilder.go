...
func (o *GetHAProxyConfigurationURL) WithBasePath(bp string) *GetHAProxyConfigurationURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetHAProxyConfigurationURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetHAProxyConfigurationURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetHAProxyConfigurationURL")
	}
