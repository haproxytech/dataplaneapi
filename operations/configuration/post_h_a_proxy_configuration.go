...
func (fn PostHAProxyConfigurationHandlerFunc) Handle(params PostHAProxyConfigurationParams, principal interface{}) middleware.Responder {
...
func (o *PostHAProxyConfiguration) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	route, rCtx, _ := o.Context.RouteInfo(r)
	if rCtx != nil {
		*r = *rCtx
	}
	var Params = NewPostHAProxyConfigurationParams()
