...
func (o *GetStickRuleParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetStickRuleParams) validateParentName(formats strfmt.Registry) error {
