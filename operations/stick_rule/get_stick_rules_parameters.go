...
func (o *GetStickRulesParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetStickRulesParams) validateParentName(formats strfmt.Registry) error {
