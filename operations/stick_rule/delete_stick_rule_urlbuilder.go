...
func (o *DeleteStickRuleURL) Build() (*url.URL, error) {
	...
	if parentName != "" {
		...
		return nil, errors.New("parentName is required on DeleteStickRuleURL")
	}
...
func (o *DeleteStickRuleURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteStickRuleURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteStickRuleURL")
	}
