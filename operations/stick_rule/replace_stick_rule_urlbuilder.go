...
type ReplaceStickRuleURL struct {
	Index      int64
	ParentName string
...
func (o *ReplaceStickRuleURL) Build() (*url.URL, error) {
	...
	if index != "" {
		...
		return nil, errors.New("index is required on ReplaceStickRuleURL")
	}
	...
	if parentName != "" {
		...
		return nil, errors.New("parentName is required on ReplaceStickRuleURL")
	}
...
func (o *ReplaceStickRuleURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ReplaceStickRuleURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ReplaceStickRuleURL")
	}
