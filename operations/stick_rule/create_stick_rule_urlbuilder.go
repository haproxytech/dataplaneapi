...
func (o *CreateStickRuleURL) Build() (*url.URL, error) {
	...
	if parentName != "" {
		...
		return nil, errors.New("parentName is required on CreateStickRuleURL")
	}
...
func (o *CreateStickRuleURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateStickRuleURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateStickRuleURL")
	}
