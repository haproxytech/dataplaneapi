...
// CreateSpoeGroupParams contains all the bound params for the create spoe group operation
// typically these are obtained from a http.Request
//
// swagger:parameters createSpoeGroup
...
//
// To ensure default values, the struct must have been initialized with NewCreateSpoeGroupParams() beforehand.
func (o *CreateSpoeGroupParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *CreateSpoeGroupParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateSpoeGroupParams) validateParentName(formats strfmt.Registry) error {
...
func (o *CreateSpoeGroupParams) bindScopeName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateSpoeGroupParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateSpoeGroupParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
