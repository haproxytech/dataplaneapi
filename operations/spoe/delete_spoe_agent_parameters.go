...
func (o *DeleteSpoeAgentParams) bindScope(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *DeleteSpoeAgentParams) bindSpoe(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
