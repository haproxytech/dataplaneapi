...
func (o *CreateSpoeMessageParams) bindScope(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *CreateSpoeMessageParams) bindSpoe(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
