...
// CreateSpoeMessageParams contains all the bound params for the create spoe message operation
// typically these are obtained from a http.Request
//
// swagger:parameters createSpoeMessage
...
//
// To ensure default values, the struct must have been initialized with NewCreateSpoeMessageParams() beforehand.
func (o *CreateSpoeMessageParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *CreateSpoeMessageParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *CreateSpoeMessageParams) validateParentName(formats strfmt.Registry) error {
...
func (o *CreateSpoeMessageParams) bindScopeName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateSpoeMessageParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateSpoeMessageParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
