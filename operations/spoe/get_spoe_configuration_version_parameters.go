...
// GetSpoeConfigurationVersionParams contains all the bound params for the get spoe configuration version operation
// typically these are obtained from a http.Request
//
// swagger:parameters getSpoeConfigurationVersion
...
//
// To ensure default values, the struct must have been initialized with NewGetSpoeConfigurationVersionParams() beforehand.
func (o *GetSpoeConfigurationVersionParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetSpoeConfigurationVersionParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetSpoeConfigurationVersionParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetSpoeConfigurationVersionParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
