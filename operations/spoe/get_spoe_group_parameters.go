...
// GetSpoeGroupParams contains all the bound params for the get spoe group operation
// typically these are obtained from a http.Request
//
// swagger:parameters getSpoeGroup
...
//
// To ensure default values, the struct must have been initialized with NewGetSpoeGroupParams() beforehand.
func (o *GetSpoeGroupParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetSpoeGroupParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetSpoeGroupParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetSpoeGroupParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetSpoeGroupParams) bindScopeName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetSpoeGroupParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
