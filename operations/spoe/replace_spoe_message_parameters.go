...
// ReplaceSpoeMessageParams contains all the bound params for the replace spoe message operation
// typically these are obtained from a http.Request
//
// swagger:parameters replaceSpoeMessage
...
//
// To ensure default values, the struct must have been initialized with NewReplaceSpoeMessageParams() beforehand.
func (o *ReplaceSpoeMessageParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ReplaceSpoeMessageParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ReplaceSpoeMessageParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceSpoeMessageParams) validateParentName(formats strfmt.Registry) error {
...
func (o *ReplaceSpoeMessageParams) bindScopeName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceSpoeMessageParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceSpoeMessageParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
