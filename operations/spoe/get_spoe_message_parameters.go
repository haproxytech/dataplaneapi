...
// GetSpoeMessageParams contains all the bound params for the get spoe message operation
// typically these are obtained from a http.Request
//
// swagger:parameters getSpoeMessage
...
//
// To ensure default values, the struct must have been initialized with NewGetSpoeMessageParams() beforehand.
func (o *GetSpoeMessageParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetSpoeMessageParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetSpoeMessageParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetSpoeMessageParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetSpoeMessageParams) bindScopeName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetSpoeMessageParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
