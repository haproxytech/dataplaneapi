...
// CreateSpoeScopeParams contains all the bound params for the create spoe scope operation
// typically these are obtained from a http.Request
//
// swagger:parameters createSpoeScope
...
//
// To ensure default values, the struct must have been initialized with NewCreateSpoeScopeParams() beforehand.
func (o *CreateSpoeScopeParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *CreateSpoeScopeParams) validateParentName(formats strfmt.Registry) error {
...
func (o *CreateSpoeScopeParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateSpoeScopeParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
