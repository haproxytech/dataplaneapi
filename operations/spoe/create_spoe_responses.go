...
func (o *CreateSpoeBadRequest) WithConfigurationVersion(configurationVersion int64) *CreateSpoeBadRequest {
	o.ConfigurationVersion = configurationVersion
	return o
}

// SetConfigurationVersion sets the configurationVersion to the create spoe bad request response
func (o *CreateSpoeBadRequest) SetConfigurationVersion(configurationVersion int64) {
	o.ConfigurationVersion = configurationVersion
}
...
func (o *CreateSpoeConflict) WithConfigurationVersion(configurationVersion int64) *CreateSpoeConflict {
	o.ConfigurationVersion = configurationVersion
	return o
}

// SetConfigurationVersion sets the configurationVersion to the create spoe conflict response
func (o *CreateSpoeConflict) SetConfigurationVersion(configurationVersion int64) {
	o.ConfigurationVersion = configurationVersion
}
...
func (o *CreateSpoeDefault) WithConfigurationVersion(configurationVersion int64) *CreateSpoeDefault {
	o.ConfigurationVersion = configurationVersion
	return o
}

// SetConfigurationVersion sets the configurationVersion to the create spoe default response
func (o *CreateSpoeDefault) SetConfigurationVersion(configurationVersion int64) {
	o.ConfigurationVersion = configurationVersion
}
