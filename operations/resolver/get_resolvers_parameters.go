...
// GetResolversParams contains all the bound params for the get resolvers operation
...
//
// To ensure default values, the struct must have been initialized with NewGetResolversParams() beforehand.
func (o *GetResolversParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetResolversParams) bindFullSection(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewGetResolversParams()
		return nil
	}
...
func (o *GetResolversParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
