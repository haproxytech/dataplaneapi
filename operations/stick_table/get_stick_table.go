...
type GetStickTableHandlerFunc func(GetStickTableParams, interface{}) middleware.Responder
...
type GetStickTableHandler interface {
	Handle(GetStickTableParams, interface{}) middleware.Responder
}
...
type GetStickTable struct {
	...
	Handler GetStickTableHandler
}

func (o *GetStickTable) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	route, rCtx, _ := o.Context.RouteInfo(r)
	if rCtx != nil {
		*r = *rCtx
	}
	var Params = NewGetStickTableParams()
