...
// DeleteTransactionParams contains all the bound params for the delete transaction operation
...
func (o *DeleteTransactionParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
