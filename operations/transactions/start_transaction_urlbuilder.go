...
func (o *StartTransactionURL) Build() (*url.URL, error) {
	...
	var _path = "/services/haproxy/transactions"
...
func (o *StartTransactionURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on StartTransactionURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on StartTransactionURL")
	}
