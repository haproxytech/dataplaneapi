...
// NewCreateHealthCheckParams creates a new CreateHealthCheckParams object
// with the default values initialized.
func NewCreateHealthCheckParams() CreateHealthCheckParams {
	...
	return CreateHealthCheckParams{
...
// CreateHealthCheckParams contains all the bound params for the create health check operation
...
//
// To ensure default values, the struct must have been initialized with NewCreateHealthCheckParams() beforehand.
func (o *CreateHealthCheckParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *CreateHealthCheckParams) bindForceReload(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewCreateHealthCheckParams()
		return nil
	}
...
func (o *CreateHealthCheckParams) bindFullSection(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateHealthCheckParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateHealthCheckParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
