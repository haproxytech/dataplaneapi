...
type GetHealthCheckHandlerFunc func(GetHealthCheckParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetHealthCheckHandlerFunc) Handle(params GetHealthCheckParams, principal interface{}) middleware.Responder {
...
type GetHealthCheckHandler interface {
	Handle(GetHealthCheckParams, interface{}) middleware.Responder
}
...
/*
	GetHealthCheck swagger:route GET /services/haproxy/configuration/healthchecks/{name} HealthCheck getHealthCheck

# Return a healthcheck

Returns one healthcheck configuration by it's name.
*/
