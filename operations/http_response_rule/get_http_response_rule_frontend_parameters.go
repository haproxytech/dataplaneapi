...
func NewGetHTTPResponseRuleFrontendParams() GetHTTPResponseRuleFrontendParams {

	return GetHTTPResponseRuleFrontendParams{}
}

// GetHTTPResponseRuleFrontendParams contains all the bound params for the get HTTP response rule frontend operation
...
//
// To ensure default values, the struct must have been initialized with NewGetHTTPResponseRuleFrontendParams() beforehand.
func (o *GetHTTPResponseRuleFrontendParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetHTTPResponseRuleFrontendParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetHTTPResponseRuleFrontendParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetHTTPResponseRuleFrontendParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetHTTPResponseRuleFrontendParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
