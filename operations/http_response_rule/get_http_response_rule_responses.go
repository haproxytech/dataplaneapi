...
type GetHTTPResponseRuleOK struct {
	...
	/*
	  In: Body
	*/
	Payload *models.GetHTTPResponseRuleOKBody `json:"body,omitempty"`
}
...
func (o *GetHTTPResponseRuleOK) WithPayload(payload *models.GetHTTPResponseRuleOKBody) *GetHTTPResponseRuleOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get Http response rule o k response
func (o *GetHTTPResponseRuleOK) SetPayload(payload *models.GetHTTPResponseRuleOKBody) {
	o.Payload = payload
}
