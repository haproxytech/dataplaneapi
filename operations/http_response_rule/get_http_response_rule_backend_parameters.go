...
func NewGetHTTPResponseRuleBackendParams() GetHTTPResponseRuleBackendParams {

	return GetHTTPResponseRuleBackendParams{}
}

// GetHTTPResponseRuleBackendParams contains all the bound params for the get HTTP response rule backend operation
...
//
// To ensure default values, the struct must have been initialized with NewGetHTTPResponseRuleBackendParams() beforehand.
func (o *GetHTTPResponseRuleBackendParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetHTTPResponseRuleBackendParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetHTTPResponseRuleBackendParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetHTTPResponseRuleBackendParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetHTTPResponseRuleBackendParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
