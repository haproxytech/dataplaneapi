...
func (o *CreateHTTPResponseRuleURL) WithBasePath(bp string) *CreateHTTPResponseRuleURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *CreateHTTPResponseRuleURL) Build() (*url.URL, error) {
	...
	if index != "" {
		...
		return nil, errors.New("index is required on CreateHTTPResponseRuleURL")
	}
...
func (o *CreateHTTPResponseRuleURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateHTTPResponseRuleURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateHTTPResponseRuleURL")
	}
