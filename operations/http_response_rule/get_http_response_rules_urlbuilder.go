...
func (o *GetHTTPResponseRulesURL) WithBasePath(bp string) *GetHTTPResponseRulesURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetHTTPResponseRulesURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetHTTPResponseRulesURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetHTTPResponseRulesURL")
	}
