...
func (o *ReplaceHTTPResponseRuleURL) WithBasePath(bp string) *ReplaceHTTPResponseRuleURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ReplaceHTTPResponseRuleURL) Build() (*url.URL, error) {
	...
	if index != "" {
		...
		return nil, errors.New("index is required on ReplaceHTTPResponseRuleURL")
	}
...
func (o *ReplaceHTTPResponseRuleURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ReplaceHTTPResponseRuleURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ReplaceHTTPResponseRuleURL")
	}
