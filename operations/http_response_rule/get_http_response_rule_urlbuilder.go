...
func (o *GetHTTPResponseRuleURL) WithBasePath(bp string) *GetHTTPResponseRuleURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetHTTPResponseRuleURL) Build() (*url.URL, error) {
	...
	if index != "" {
		...
		return nil, errors.New("index is required on GetHTTPResponseRuleURL")
	}
...
func (o *GetHTTPResponseRuleURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetHTTPResponseRuleURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetHTTPResponseRuleURL")
	}
