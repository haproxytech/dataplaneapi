...
type ReplaceHTTPCheckHandlerFunc func(ReplaceHTTPCheckParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceHTTPCheckHandlerFunc) Handle(params ReplaceHTTPCheckParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// ReplaceHTTPCheckHandler interface for that can handle valid replace HTTP check params
type ReplaceHTTPCheckHandler interface {
	Handle(ReplaceHTTPCheckParams, interface{}) middleware.Responder
}

// NewReplaceHTTPCheck creates a new http.Handler for the replace HTTP check operation
func NewReplaceHTTPCheck(ctx *middleware.Context, handler ReplaceHTTPCheckHandler) *ReplaceHTTPCheck {
...
type ReplaceHTTPCheck struct {
	...
	Handler ReplaceHTTPCheckHandler
}

func (o *ReplaceHTTPCheck) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	route, rCtx, _ := o.Context.RouteInfo(r)
	if rCtx != nil {
		r = rCtx
	}
	var Params = NewReplaceHTTPCheckParams()
