...
// GetHTTPCheckParams contains all the bound params for the get HTTP check operation
// typically these are obtained from a http.Request
//
// swagger:parameters getHTTPCheck
...
//
// To ensure default values, the struct must have been initialized with NewGetHTTPCheckParams() beforehand.
func (o *GetHTTPCheckParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetHTTPCheckParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetHTTPCheckParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetHTTPCheckParams) bindParentType(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetHTTPCheckParams) validateParentType(formats strfmt.Registry) error {
...
func (o *GetHTTPCheckParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
