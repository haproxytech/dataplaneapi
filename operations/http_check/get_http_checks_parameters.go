...
// GetHTTPChecksParams contains all the bound params for the get HTTP checks operation
// typically these are obtained from a http.Request
//
// swagger:parameters getHTTPChecks
...
//
// To ensure default values, the struct must have been initialized with NewGetHTTPChecksParams() beforehand.
func (o *GetHTTPChecksParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetHTTPChecksParams) bindParentType(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetHTTPChecksParams) validateParentType(formats strfmt.Registry) error {
...
func (o *GetHTTPChecksParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
