...
// NewReplaceHTTPChecksParams creates a new ReplaceHTTPChecksParams object
// with the default values initialized.
func NewReplaceHTTPChecksParams() ReplaceHTTPChecksParams {
	...
	return ReplaceHTTPChecksParams{
		ForceReload: &forceReloadDefault,
	}
}

// ReplaceHTTPChecksParams contains all the bound params for the replace HTTP checks operation
// typically these are obtained from a http.Request
//
// swagger:parameters replaceHTTPChecks
type ReplaceHTTPChecksParams struct {
...
//
// To ensure default values, the struct must have been initialized with NewReplaceHTTPChecksParams() beforehand.
func (o *ReplaceHTTPChecksParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ReplaceHTTPChecksParams) bindForceReload(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewReplaceHTTPChecksParams()
		return nil
	}
...
func (o *ReplaceHTTPChecksParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *ReplaceHTTPChecksParams) bindParentType(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *ReplaceHTTPChecksParams) validateParentType(formats strfmt.Registry) error {
...
func (o *ReplaceHTTPChecksParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceHTTPChecksParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
