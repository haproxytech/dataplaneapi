...
func (o *GetFrontendsURL) Build() (*url.URL, error) {
	...
	var _path = "/services/haproxy/configuration/frontends"
...
func (o *GetFrontendsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetFrontendsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetFrontendsURL")
	}
