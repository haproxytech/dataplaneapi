...
type GetFrontendOK struct {
	...
	/*
	  In: Body
	*/
	Payload *models.GetFrontendOKBody `json:"body,omitempty"`
}
...
func (o *GetFrontendOK) WithPayload(payload *models.GetFrontendOKBody) *GetFrontendOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get frontend o k response
func (o *GetFrontendOK) SetPayload(payload *models.GetFrontendOKBody) {
	o.Payload = payload
}
