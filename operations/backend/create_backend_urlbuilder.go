...
func (o *CreateBackendURL) Build() (*url.URL, error) {
	...
	var _path = "/services/haproxy/configuration/backends"
...
func (o *CreateBackendURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateBackendURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateBackendURL")
	}
