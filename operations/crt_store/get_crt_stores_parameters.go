...
func NewGetCrtStoresParams() GetCrtStoresParams {
	...
	return GetCrtStoresParams{
		FullSection: &fullSectionDefault,
	}
}

// GetCrtStoresParams contains all the bound params for the get crt stores operation
...
//
// To ensure default values, the struct must have been initialized with NewGetCrtStoresParams() beforehand.
func (o *GetCrtStoresParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetCrtStoresParams) bindFullSection(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewGetCrtStoresParams()
		return nil
	}
...
func (o *GetCrtStoresParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
