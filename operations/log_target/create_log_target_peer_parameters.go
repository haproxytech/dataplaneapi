...
// NewCreateLogTargetPeerParams creates a new CreateLogTargetPeerParams object
// with the default values initialized.
func NewCreateLogTargetPeerParams() CreateLogTargetPeerParams {
	...
	return CreateLogTargetPeerParams{
		ForceReload: &forceReloadDefault,
	}
}

// CreateLogTargetPeerParams contains all the bound params for the create log target peer operation
...
//
// To ensure default values, the struct must have been initialized with NewCreateLogTargetPeerParams() beforehand.
func (o *CreateLogTargetPeerParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *CreateLogTargetPeerParams) bindForceReload(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewCreateLogTargetPeerParams()
		return nil
	}
...
func (o *CreateLogTargetPeerParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateLogTargetPeerParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateLogTargetPeerParams) validateParentName(formats strfmt.Registry) error {
...
func (o *CreateLogTargetPeerParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateLogTargetPeerParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
