...
func NewGetLogTargetFrontendParams() GetLogTargetFrontendParams {

	return GetLogTargetFrontendParams{}
}

// GetLogTargetFrontendParams contains all the bound params for the get log target frontend operation
...
//
// To ensure default values, the struct must have been initialized with NewGetLogTargetFrontendParams() beforehand.
func (o *GetLogTargetFrontendParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetLogTargetFrontendParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetLogTargetFrontendParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetLogTargetFrontendParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetLogTargetFrontendParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
