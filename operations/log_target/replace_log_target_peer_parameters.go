...
// NewReplaceLogTargetPeerParams creates a new ReplaceLogTargetPeerParams object
// with the default values initialized.
func NewReplaceLogTargetPeerParams() ReplaceLogTargetPeerParams {
	...
	return ReplaceLogTargetPeerParams{
		ForceReload: &forceReloadDefault,
	}
}

// ReplaceLogTargetPeerParams contains all the bound params for the replace log target peer operation
...
//
// To ensure default values, the struct must have been initialized with NewReplaceLogTargetPeerParams() beforehand.
func (o *ReplaceLogTargetPeerParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ReplaceLogTargetPeerParams) bindForceReload(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewReplaceLogTargetPeerParams()
		return nil
	}
...
func (o *ReplaceLogTargetPeerParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceLogTargetPeerParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceLogTargetPeerParams) validateParentName(formats strfmt.Registry) error {
...
func (o *ReplaceLogTargetPeerParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceLogTargetPeerParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
