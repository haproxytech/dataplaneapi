...
func NewGetLogTargetLogForwardParams() GetLogTargetLogForwardParams {

	return GetLogTargetLogForwardParams{}
}

// GetLogTargetLogForwardParams contains all the bound params for the get log target log forward operation
...
//
// To ensure default values, the struct must have been initialized with NewGetLogTargetLogForwardParams() beforehand.
func (o *GetLogTargetLogForwardParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetLogTargetLogForwardParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetLogTargetLogForwardParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetLogTargetLogForwardParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetLogTargetLogForwardParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
