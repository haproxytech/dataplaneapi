...
func NewGetAllLogTargetLogForwardParams() GetAllLogTargetLogForwardParams {

	return GetAllLogTargetLogForwardParams{}
}
...
//
// To ensure default values, the struct must have been initialized with NewGetAllLogTargetLogForwardParams() beforehand.
func (o *GetAllLogTargetLogForwardParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetAllLogTargetLogForwardParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetAllLogTargetLogForwardParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetAllLogTargetLogForwardParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
