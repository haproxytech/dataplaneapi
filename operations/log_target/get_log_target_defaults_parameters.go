...
func NewGetLogTargetDefaultsParams() GetLogTargetDefaultsParams {

	return GetLogTargetDefaultsParams{}
}

// GetLogTargetDefaultsParams contains all the bound params for the get log target defaults operation
...
//
// To ensure default values, the struct must have been initialized with NewGetLogTargetDefaultsParams() beforehand.
func (o *GetLogTargetDefaultsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetLogTargetDefaultsParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetLogTargetDefaultsParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetLogTargetDefaultsParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetLogTargetDefaultsParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
