...
func NewGetLogTargetBackendParams() GetLogTargetBackendParams {

	return GetLogTargetBackendParams{}
}

// GetLogTargetBackendParams contains all the bound params for the get log target backend operation
...
//
// To ensure default values, the struct must have been initialized with NewGetLogTargetBackendParams() beforehand.
func (o *GetLogTargetBackendParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetLogTargetBackendParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetLogTargetBackendParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetLogTargetBackendParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetLogTargetBackendParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
