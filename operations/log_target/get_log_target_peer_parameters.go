...
func NewGetLogTargetPeerParams() GetLogTargetPeerParams {

	return GetLogTargetPeerParams{}
}

// GetLogTargetPeerParams contains all the bound params for the get log target peer operation
...
//
// To ensure default values, the struct must have been initialized with NewGetLogTargetPeerParams() beforehand.
func (o *GetLogTargetPeerParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetLogTargetPeerParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetLogTargetPeerParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetLogTargetPeerParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetLogTargetPeerParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
