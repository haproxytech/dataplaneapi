...
// GetDefaultsParams contains all the bound params for the get defaults operation
...
func (o *GetDefaultsParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
