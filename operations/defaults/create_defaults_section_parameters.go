...
// NewCreateDefaultsSectionParams creates a new CreateDefaultsSectionParams object
...
func NewCreateDefaultsSectionParams() CreateDefaultsSectionParams {
	...
	return CreateDefaultsSectionParams{
...
// CreateDefaultsSectionParams contains all the bound params for the create defaults section operation
...
//
// To ensure default values, the struct must have been initialized with NewCreateDefaultsSectionParams() beforehand.
func (o *CreateDefaultsSectionParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *CreateDefaultsSectionParams) bindForceReload(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewCreateDefaultsSectionParams()
		return nil
	}
...
func (o *CreateDefaultsSectionParams) bindFullSection(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateDefaultsSectionParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateDefaultsSectionParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
