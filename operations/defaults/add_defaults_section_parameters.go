...
// NewAddDefaultsSectionParams creates a new AddDefaultsSectionParams object
// with the default values initialized.
func NewAddDefaultsSectionParams() AddDefaultsSectionParams {
	...
	return AddDefaultsSectionParams{
...
// AddDefaultsSectionParams contains all the bound params for the add defaults section operation
...
//
// To ensure default values, the struct must have been initialized with NewAddDefaultsSectionParams() beforehand.
func (o *AddDefaultsSectionParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *AddDefaultsSectionParams) bindForceReload(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewAddDefaultsSectionParams()
		return nil
	}
...
func (o *AddDefaultsSectionParams) bindFullSection(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *AddDefaultsSectionParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *AddDefaultsSectionParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
