...
func NewGetQUICInitialRuleFrontendParams() GetQUICInitialRuleFrontendParams {

	return GetQUICInitialRuleFrontendParams{}
}

// GetQUICInitialRuleFrontendParams contains all the bound params for the get QUIC initial rule frontend operation
...
//
// To ensure default values, the struct must have been initialized with NewGetQUICInitialRuleFrontendParams() beforehand.
func (o *GetQUICInitialRuleFrontendParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetQUICInitialRuleFrontendParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetQUICInitialRuleFrontendParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetQUICInitialRuleFrontendParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetQUICInitialRuleFrontendParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
