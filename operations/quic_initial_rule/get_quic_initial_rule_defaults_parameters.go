...
func NewGetQUICInitialRuleDefaultsParams() GetQUICInitialRuleDefaultsParams {

	return GetQUICInitialRuleDefaultsParams{}
}

// GetQUICInitialRuleDefaultsParams contains all the bound params for the get QUIC initial rule defaults operation
...
//
// To ensure default values, the struct must have been initialized with NewGetQUICInitialRuleDefaultsParams() beforehand.
func (o *GetQUICInitialRuleDefaultsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetQUICInitialRuleDefaultsParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetQUICInitialRuleDefaultsParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetQUICInitialRuleDefaultsParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetQUICInitialRuleDefaultsParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
