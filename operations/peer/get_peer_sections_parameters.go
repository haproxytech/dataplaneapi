...
//
// To ensure default values, the struct must have been initialized with NewGetPeerSectionsParams() beforehand.
func (o *GetPeerSectionsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetPeerSectionsParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
