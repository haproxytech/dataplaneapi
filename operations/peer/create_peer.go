...
type CreatePeerHandlerFunc func(CreatePeerParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn CreatePeerHandlerFunc) Handle(params CreatePeerParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// CreatePeerHandler interface for that can handle valid create peer params
type CreatePeerHandler interface {
	Handle(CreatePeerParams, interface{}) middleware.Responder
}
