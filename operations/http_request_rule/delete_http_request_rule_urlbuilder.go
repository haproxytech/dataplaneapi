...
func (o *DeleteHTTPRequestRuleURL) WithBasePath(bp string) *DeleteHTTPRequestRuleURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *DeleteHTTPRequestRuleURL) Build() (*url.URL, error) {
	...
	if index != "" {
		...
		return nil, errors.New("index is required on DeleteHTTPRequestRuleURL")
	}
...
func (o *DeleteHTTPRequestRuleURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteHTTPRequestRuleURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteHTTPRequestRuleURL")
	}
