...
// CreateHTTPRequestRuleParams contains all the bound params for the create HTTP request rule operation
...
func (o *CreateHTTPRequestRuleParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *CreateHTTPRequestRuleParams) bindForceReload(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewCreateHTTPRequestRuleParams()
		return nil
	}
...
func (o *CreateHTTPRequestRuleParams) validateParentType(formats strfmt.Registry) error {
...
func (o *CreateHTTPRequestRuleParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateHTTPRequestRuleParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
