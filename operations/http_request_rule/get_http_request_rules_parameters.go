...
// GetHTTPRequestRulesParams contains all the bound params for the get HTTP request rules operation
...
func (o *GetHTTPRequestRulesParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetHTTPRequestRulesParams) validateParentType(formats strfmt.Registry) error {
...
func (o *GetHTTPRequestRulesParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
