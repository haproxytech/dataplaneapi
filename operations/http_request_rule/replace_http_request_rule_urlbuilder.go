...
func (o *ReplaceHTTPRequestRuleURL) WithBasePath(bp string) *ReplaceHTTPRequestRuleURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ReplaceHTTPRequestRuleURL) Build() (*url.URL, error) {
	...
	if index != "" {
		...
		return nil, errors.New("index is required on ReplaceHTTPRequestRuleURL")
	}
...
func (o *ReplaceHTTPRequestRuleURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ReplaceHTTPRequestRuleURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ReplaceHTTPRequestRuleURL")
	}
