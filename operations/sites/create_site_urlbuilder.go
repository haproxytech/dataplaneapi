...
func (o *CreateSiteURL) Build() (*url.URL, error) {
	...
	var _path = "/services/haproxy/sites"
...
func (o *CreateSiteURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateSiteURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateSiteURL")
	}
