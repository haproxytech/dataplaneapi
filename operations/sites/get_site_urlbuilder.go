...
func (o *GetSiteURL) Build() (*url.URL, error) {
	...
	if name != "" {
		...
		return nil, errors.New("name is required on GetSiteURL")
	}
...
func (o *GetSiteURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetSiteURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetSiteURL")
	}
