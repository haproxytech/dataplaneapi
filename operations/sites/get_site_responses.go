...
type GetSiteOK struct {
	...
	/*
	  In: Body
	*/
	Payload *models.GetSiteOKBody `json:"body,omitempty"`
}
...
func (o *GetSiteOK) WithPayload(payload *models.GetSiteOKBody) *GetSiteOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get site o k response
func (o *GetSiteOK) SetPayload(payload *models.GetSiteOKBody) {
	o.Payload = payload
}
