...
func NewGetHTTPErrorRuleDefaultsParams() GetHTTPErrorRuleDefaultsParams {

	return GetHTTPErrorRuleDefaultsParams{}
}

// GetHTTPErrorRuleDefaultsParams contains all the bound params for the get HTTP error rule defaults operation
...
//
// To ensure default values, the struct must have been initialized with NewGetHTTPErrorRuleDefaultsParams() beforehand.
func (o *GetHTTPErrorRuleDefaultsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetHTTPErrorRuleDefaultsParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetHTTPErrorRuleDefaultsParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetHTTPErrorRuleDefaultsParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetHTTPErrorRuleDefaultsParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
