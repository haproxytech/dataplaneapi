...
func NewGetHTTPErrorRuleFrontendParams() GetHTTPErrorRuleFrontendParams {

	return GetHTTPErrorRuleFrontendParams{}
}

// GetHTTPErrorRuleFrontendParams contains all the bound params for the get HTTP error rule frontend operation
...
//
// To ensure default values, the struct must have been initialized with NewGetHTTPErrorRuleFrontendParams() beforehand.
func (o *GetHTTPErrorRuleFrontendParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetHTTPErrorRuleFrontendParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetHTTPErrorRuleFrontendParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetHTTPErrorRuleFrontendParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetHTTPErrorRuleFrontendParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
