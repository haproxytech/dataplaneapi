...
func NewGetHTTPErrorRuleBackendParams() GetHTTPErrorRuleBackendParams {

	return GetHTTPErrorRuleBackendParams{}
}

// GetHTTPErrorRuleBackendParams contains all the bound params for the get HTTP error rule backend operation
...
//
// To ensure default values, the struct must have been initialized with NewGetHTTPErrorRuleBackendParams() beforehand.
func (o *GetHTTPErrorRuleBackendParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetHTTPErrorRuleBackendParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetHTTPErrorRuleBackendParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetHTTPErrorRuleBackendParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetHTTPErrorRuleBackendParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
