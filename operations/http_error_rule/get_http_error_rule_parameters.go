...
// GetHTTPErrorRuleParams contains all the bound params for the get HTTP error rule operation
...
//
// To ensure default values, the struct must have been initialized with NewGetHTTPErrorRuleParams() beforehand.
func (o *GetHTTPErrorRuleParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetHTTPErrorRuleParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetHTTPErrorRuleParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetHTTPErrorRuleParams) bindParentType(rawData []string, hasKey bool, formats strfmt.Registry) error {
	if !hasKey {
...
func (o *GetHTTPErrorRuleParams) validateParentType(formats strfmt.Registry) error {
...
func (o *GetHTTPErrorRuleParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
