...
// ReplaceDeclareCaptureParams contains all the bound params for the replace declare capture operation
...
//
// To ensure default values, the struct must have been initialized with NewReplaceDeclareCaptureParams() beforehand.
func (o *ReplaceDeclareCaptureParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ReplaceDeclareCaptureParams) bindForceReload(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewReplaceDeclareCaptureParams()
		return nil
	}
...
func (o *ReplaceDeclareCaptureParams) validateParentName(formats strfmt.Registry) error {
...
func (o *ReplaceDeclareCaptureParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *ReplaceDeclareCaptureParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
