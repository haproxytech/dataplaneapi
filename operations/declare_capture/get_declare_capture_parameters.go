...
// GetDeclareCaptureParams contains all the bound params for the get declare capture operation
...
//
// To ensure default values, the struct must have been initialized with NewGetDeclareCaptureParams() beforehand.
func (o *GetDeclareCaptureParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetDeclareCaptureParams) bindIndex(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetDeclareCaptureParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetDeclareCaptureParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetDeclareCaptureParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
