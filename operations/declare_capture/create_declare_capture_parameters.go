...
// CreateDeclareCaptureParams contains all the bound params for the create declare capture operation
...
//
// To ensure default values, the struct must have been initialized with NewCreateDeclareCaptureParams() beforehand.
func (o *CreateDeclareCaptureParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *CreateDeclareCaptureParams) bindForceReload(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewCreateDeclareCaptureParams()
		return nil
	}
...
func (o *CreateDeclareCaptureParams) validateParentName(formats strfmt.Registry) error {
...
func (o *CreateDeclareCaptureParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateDeclareCaptureParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
