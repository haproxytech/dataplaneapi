...
// GetDeclareCapturesParams contains all the bound params for the get declare captures operation
...
//
// To ensure default values, the struct must have been initialized with NewGetDeclareCapturesParams() beforehand.
func (o *GetDeclareCapturesParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetDeclareCapturesParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetDeclareCapturesParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetDeclareCapturesParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
