...
func (o *ReplaceDeclareCapturesURL) WithBasePath(bp string) *ReplaceDeclareCapturesURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *ReplaceDeclareCapturesURL) SetBasePath(bp string) {
	o._basePath = bp
}
...
func (o *ReplaceDeclareCapturesURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *ReplaceDeclareCapturesURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *ReplaceDeclareCapturesURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ReplaceDeclareCapturesURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ReplaceDeclareCapturesURL")
	}
...
func (o *ReplaceDeclareCapturesURL) StringFull(scheme, host string) string {
