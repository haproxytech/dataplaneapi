...
func (o *GetStorageEndpointsDefault) WithConfigurationVersion(configurationVersion int64) *GetStorageEndpointsDefault {
	o.ConfigurationVersion = configurationVersion
	return o
}

// SetConfigurationVersion sets the configurationVersion to the get storage endpoints default response
func (o *GetStorageEndpointsDefault) SetConfigurationVersion(configurationVersion int64) {
	o.ConfigurationVersion = configurationVersion
}
