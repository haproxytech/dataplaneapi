...
type GetRuntimeEndpointsHandlerFunc func(GetRuntimeEndpointsParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetRuntimeEndpointsHandlerFunc) Handle(params GetRuntimeEndpointsParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// GetRuntimeEndpointsHandler interface for that can handle valid get runtime endpoints params
type GetRuntimeEndpointsHandler interface {
	Handle(GetRuntimeEndpointsParams, interface{}) middleware.Responder
}

// NewGetRuntimeEndpoints creates a new http.Handler for the get runtime endpoints operation
func NewGetRuntimeEndpoints(ctx *middleware.Context, handler GetRuntimeEndpointsHandler) *GetRuntimeEndpoints {
...
type GetRuntimeEndpoints struct {
	...
	Handler GetRuntimeEndpointsHandler
}

func (o *GetRuntimeEndpoints) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	route, rCtx, _ := o.Context.RouteInfo(r)
	if rCtx != nil {
		*r = *rCtx
	}
	var Params = NewGetRuntimeEndpointsParams()
