...
func (o *GetConfigurationEndpointsURL) WithBasePath(bp string) *GetConfigurationEndpointsURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetConfigurationEndpointsURL) Build() (*url.URL, error) {
	...
	var _path = "/services/haproxy/configuration"
...
func (o *GetConfigurationEndpointsURL) String() string {
...
func (o *GetConfigurationEndpointsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetConfigurationEndpointsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetConfigurationEndpointsURL")
	}
