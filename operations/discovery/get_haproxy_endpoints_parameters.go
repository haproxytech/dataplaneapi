...
// GetHaproxyEndpointsParams contains all the bound params for the get haproxy endpoints operation
...
func (o *GetHaproxyEndpointsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
