...
func (o *GetHaproxyEndpointsURL) WithBasePath(bp string) *GetHaproxyEndpointsURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetHaproxyEndpointsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetHaproxyEndpointsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetHaproxyEndpointsURL")
	}
