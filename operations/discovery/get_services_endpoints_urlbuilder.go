...
func (o *GetServicesEndpointsURL) WithBasePath(bp string) *GetServicesEndpointsURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetServicesEndpointsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetServicesEndpointsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetServicesEndpointsURL")
	}
