...
func (fn GetConfigurationEndpointsHandlerFunc) Handle(params GetConfigurationEndpointsParams, principal interface{}) middleware.Responder {
...
func (o *GetConfigurationEndpoints) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	route, rCtx, _ := o.Context.RouteInfo(r)
	if rCtx != nil {
		*r = *rCtx
	}
	var Params = NewGetConfigurationEndpointsParams()
