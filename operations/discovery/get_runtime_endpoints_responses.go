...
func (o *GetRuntimeEndpointsDefault) WithConfigurationVersion(configurationVersion int64) *GetRuntimeEndpointsDefault {
	o.ConfigurationVersion = configurationVersion
	return o
}

// SetConfigurationVersion sets the configurationVersion to the get runtime endpoints default response
func (o *GetRuntimeEndpointsDefault) SetConfigurationVersion(configurationVersion int64) {
	o.ConfigurationVersion = configurationVersion
}
