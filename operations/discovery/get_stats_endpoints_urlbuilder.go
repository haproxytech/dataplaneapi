...
func (o *GetStatsEndpointsURL) Build() (*url.URL, error) {
	...
	var _path = "/services/haproxy/stats"
...
func (o *GetStatsEndpointsURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetStatsEndpointsURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetStatsEndpointsURL")
	}
