...
type CreateLogForwardHandlerFunc func(CreateLogForwardParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn CreateLogForwardHandlerFunc) Handle(params CreateLogForwardParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// CreateLogForwardHandler interface for that can handle valid create log forward params
type CreateLogForwardHandler interface {
	Handle(CreateLogForwardParams, interface{}) middleware.Responder
}
...
type CreateLogForward struct {
	...
	Handler CreateLogForwardHandler
}

func (o *CreateLogForward) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	route, rCtx, _ := o.Context.RouteInfo(r)
	if rCtx != nil {
		*r = *rCtx
	}
	var Params = NewCreateLogForwardParams()
