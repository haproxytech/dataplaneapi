...
type DeleteTableHandlerFunc func(DeleteTableParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteTableHandlerFunc) Handle(params DeleteTableParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// DeleteTableHandler interface for that can handle valid delete table params
type DeleteTableHandler interface {
	Handle(DeleteTableParams, interface{}) middleware.Responder
}
