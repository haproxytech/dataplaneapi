...
type ShowRuntimeMapHandlerFunc func(ShowRuntimeMapParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ShowRuntimeMapHandlerFunc) Handle(params ShowRuntimeMapParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// ShowRuntimeMapHandler interface for that can handle valid show runtime map params
type ShowRuntimeMapHandler interface {
	Handle(ShowRuntimeMapParams, interface{}) middleware.Responder
}

// NewShowRuntimeMap creates a new http.Handler for the show runtime map operation
func NewShowRuntimeMap(ctx *middleware.Context, handler ShowRuntimeMapHandler) *ShowRuntimeMap {
...
type ShowRuntimeMap struct {
	...
	Handler ShowRuntimeMapHandler
}

func (o *ShowRuntimeMap) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	route, rCtx, _ := o.Context.RouteInfo(r)
	if rCtx != nil {
		*r = *rCtx
	}
	var Params = NewShowRuntimeMapParams()
