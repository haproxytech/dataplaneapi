...
type CreatePeerEntryHandlerFunc func(CreatePeerEntryParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn CreatePeerEntryHandlerFunc) Handle(params CreatePeerEntryParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// CreatePeerEntryHandler interface for that can handle valid create peer entry params
type CreatePeerEntryHandler interface {
	Handle(CreatePeerEntryParams, interface{}) middleware.Responder
}

// NewCreatePeerEntry creates a new http.Handler for the create peer entry operation
func NewCreatePeerEntry(ctx *middleware.Context, handler CreatePeerEntryHandler) *CreatePeerEntry {
...
type CreatePeerEntry struct {
	...
	Handler CreatePeerEntryHandler
}

func (o *CreatePeerEntry) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	route, rCtx, _ := o.Context.RouteInfo(r)
	if rCtx != nil {
		*r = *rCtx
	}
	var Params = NewCreatePeerEntryParams()
