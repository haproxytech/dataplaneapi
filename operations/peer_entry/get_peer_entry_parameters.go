...
// GetPeerEntryParams contains all the bound params for the get peer entry operation
...
//
// To ensure default values, the struct must have been initialized with NewGetPeerEntryParams() beforehand.
func (o *GetPeerEntryParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetPeerEntryParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetPeerEntryParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
