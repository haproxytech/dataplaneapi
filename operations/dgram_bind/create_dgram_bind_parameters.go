...
// CreateDgramBindParams contains all the bound params for the create dgram bind operation
...
//
// To ensure default values, the struct must have been initialized with NewCreateDgramBindParams() beforehand.
func (o *CreateDgramBindParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *CreateDgramBindParams) bindForceReload(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewCreateDgramBindParams()
		return nil
	}
...
func (o *CreateDgramBindParams) validateParentName(formats strfmt.Registry) error {
...
func (o *CreateDgramBindParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *CreateDgramBindParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
