...
// GetDgramBindsParams contains all the bound params for the get dgram binds operation
...
//
// To ensure default values, the struct must have been initialized with NewGetDgramBindsParams() beforehand.
func (o *GetDgramBindsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetDgramBindsParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetDgramBindsParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetDgramBindsParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
