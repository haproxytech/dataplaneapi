...
func (o *DeleteDgramBindURL) WithBasePath(bp string) *DeleteDgramBindURL {
	o.SetBasePath(bp)
	return o
}
...
// base path specified in the swagger spec.
// When the value of the base path is an empty string
func (o *DeleteDgramBindURL) SetBasePath(bp string) {
	o._basePath = bp
}
...
func (o *DeleteDgramBindURL) Must(u *url.URL, err error) *url.URL {
	if err != nil {
		panic(err)
	}
	if u == nil {
...
func (o *DeleteDgramBindURL) String() string {
	return o.Must(o.Build()).String()
}

// BuildFull builds a full url with scheme, host, path and query string
func (o *DeleteDgramBindURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteDgramBindURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteDgramBindURL")
	}
...
func (o *DeleteDgramBindURL) StringFull(scheme, host string) string {
