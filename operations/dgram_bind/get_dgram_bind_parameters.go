...
// GetDgramBindParams contains all the bound params for the get dgram bind operation
...
//
// To ensure default values, the struct must have been initialized with NewGetDgramBindParams() beforehand.
func (o *GetDgramBindParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetDgramBindParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetDgramBindParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
