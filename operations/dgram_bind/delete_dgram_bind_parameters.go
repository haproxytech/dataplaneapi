...
// DeleteDgramBindParams contains all the bound params for the delete dgram bind operation
...
//
// To ensure default values, the struct must have been initialized with NewDeleteDgramBindParams() beforehand.
func (o *DeleteDgramBindParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *DeleteDgramBindParams) bindForceReload(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DeleteDgramBindParams) validateParentName(formats strfmt.Registry) error {
...
func (o *DeleteDgramBindParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *DeleteDgramBindParams) bindVersion(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
