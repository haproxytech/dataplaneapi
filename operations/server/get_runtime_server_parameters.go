...
// GetRuntimeServerParams contains all the bound params for the get runtime server operation
...
//
// To ensure default values, the struct must have been initialized with NewGetRuntimeServerParams() beforehand.
func (o *GetRuntimeServerParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetRuntimeServerParams) bindName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetRuntimeServerParams) validateParentName(formats strfmt.Registry) error {
