...
func (o *DeleteServerURL) Build() (*url.URL, error) {
	...
	if name != "" {
		...
		return nil, errors.New("name is required on DeleteServerURL")
	}
...
func (o *DeleteServerURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on DeleteServerURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on DeleteServerURL")
	}
