...
type GetRuntimeServerHandlerFunc func(GetRuntimeServerParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn GetRuntimeServerHandlerFunc) Handle(params GetRuntimeServerParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// GetRuntimeServerHandler interface for that can handle valid get runtime server params
type GetRuntimeServerHandler interface {
	Handle(GetRuntimeServerParams, interface{}) middleware.Responder
}

// NewGetRuntimeServer creates a new http.Handler for the get runtime server operation
func NewGetRuntimeServer(ctx *middleware.Context, handler GetRuntimeServerHandler) *GetRuntimeServer {
...
type GetRuntimeServer struct {
	...
	Handler GetRuntimeServerHandler
}

func (o *GetRuntimeServer) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	route, rCtx, _ := o.Context.RouteInfo(r)
	if rCtx != nil {
		*r = *rCtx
	}
	var Params = NewGetRuntimeServerParams()
