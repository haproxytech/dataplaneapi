...
func NewGetAllServerBackendParams() GetAllServerBackendParams {

	return GetAllServerBackendParams{}
}

// GetAllServerBackendParams contains all the bound params for the get all server backend operation
...
//
// To ensure default values, the struct must have been initialized with NewGetAllServerBackendParams() beforehand.
func (o *GetAllServerBackendParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetAllServerBackendParams) bindParentName(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetAllServerBackendParams) validateParentName(formats strfmt.Registry) error {
...
func (o *GetAllServerBackendParams) bindTransactionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
