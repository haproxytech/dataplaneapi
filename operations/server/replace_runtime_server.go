...
type ReplaceRuntimeServerHandlerFunc func(ReplaceRuntimeServerParams, interface{}) middleware.Responder

// Handle executing the request and returning a response
func (fn ReplaceRuntimeServerHandlerFunc) Handle(params ReplaceRuntimeServerParams, principal interface{}) middleware.Responder {
	return fn(params, principal)
}

// ReplaceRuntimeServerHandler interface for that can handle valid replace runtime server params
type ReplaceRuntimeServerHandler interface {
	Handle(ReplaceRuntimeServerParams, interface{}) middleware.Responder
}

// NewReplaceRuntimeServer creates a new http.Handler for the replace runtime server operation
func NewReplaceRuntimeServer(ctx *middleware.Context, handler ReplaceRuntimeServerHandler) *ReplaceRuntimeServer {
...
type ReplaceRuntimeServer struct {
	...
	Handler ReplaceRuntimeServerHandler
}

func (o *ReplaceRuntimeServer) ServeHTTP(rw http.ResponseWriter, r *http.Request) {
	route, rCtx, _ := o.Context.RouteInfo(r)
	if rCtx != nil {
		*r = *rCtx
	}
	var Params = NewReplaceRuntimeServerParams()
