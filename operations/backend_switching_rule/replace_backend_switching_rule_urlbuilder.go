...
func (o *ReplaceBackendSwitchingRuleURL) WithBasePath(bp string) *ReplaceBackendSwitchingRuleURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *ReplaceBackendSwitchingRuleURL) Build() (*url.URL, error) {
	...
	if parentName != "" {
		...
		return nil, errors.New("parentName is required on ReplaceBackendSwitchingRuleURL")
	}
...
func (o *ReplaceBackendSwitchingRuleURL) String() string {
...
func (o *ReplaceBackendSwitchingRuleURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ReplaceBackendSwitchingRuleURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ReplaceBackendSwitchingRuleURL")
	}
