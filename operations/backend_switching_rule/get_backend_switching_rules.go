...
/*
	GetBackendSwitchingRules swagger:route GET /services/haproxy/configuration/frontends/{parent_name}/backend_switching_rules BackendSwitchingRule getBackendSwitchingRules
