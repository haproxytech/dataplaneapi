...
func (o *GetBackendSwitchingRulesURL) WithBasePath(bp string) *GetBackendSwitchingRulesURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetBackendSwitchingRulesURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetBackendSwitchingRulesURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetBackendSwitchingRulesURL")
	}
