...
func (o *GetBackendSwitchingRuleURL) WithBasePath(bp string) *GetBackendSwitchingRuleURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *GetBackendSwitchingRuleURL) Build() (*url.URL, error) {
	...
	if index != "" {
		...
		return nil, errors.New("index is required on GetBackendSwitchingRuleURL")
	}
	...
	if parentName != "" {
		...
		return nil, errors.New("parentName is required on GetBackendSwitchingRuleURL")
	}
...
func (o *GetBackendSwitchingRuleURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetBackendSwitchingRuleURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetBackendSwitchingRuleURL")
	}
