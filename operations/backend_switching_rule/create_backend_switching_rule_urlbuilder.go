...
func (o *CreateBackendSwitchingRuleURL) WithBasePath(bp string) *CreateBackendSwitchingRuleURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *CreateBackendSwitchingRuleURL) String() string {
...
func (o *CreateBackendSwitchingRuleURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on CreateBackendSwitchingRuleURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on CreateBackendSwitchingRuleURL")
	}
