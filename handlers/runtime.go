...
func changeThroughRuntimeAPI(data, ondisk any, parentName string, client client_native.HAProxyClient) (reload bool) {
...
func compareObjects(data, ondisk any) []string {
	diff := make([]string, 0)
