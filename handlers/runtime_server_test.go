	...
	tests := []struct {
		...
		},
		{
			...
			srv: &models.RuntimeAddServer{
				...
				Downinter:          new(int64(2000)),
				ErrorLimit:         new(int64(10)),
				Fall:               new(int64(2)),
				Fastinter:          new(int64(500)),
				ForceSslv3:         "enabled",
				ForceTlsv10:        "enabled",
				ForceTlsv11:        "enabled",
				ForceTlsv12:        "enabled",
				ForceTlsv13:        "enabled",
				HealthCheckAddress: "127.0.0.2",
				HealthCheckPort:    new(int64(8080)),
				Inter:              new(int64(3000)),
				Maxconn:            new(int64(100)),
				Maxqueue:           new(int64(200)),
				Minconn:            new(int64(50)),
				Rise:               new(int64(1)),
			},
			version: &cn_runtime.HAProxyVersion{},
