...
type HAProxyConfiguration struct {
	...
	MapsDir              string `short:"p" long:"maps-dir" description:"Path to runtime maps directory. If set, it reads from specified dir, otherwise it reads from config file"`
	StorageMapsDir       string `long:"storage-maps-dir" description:"Path to maps directory"`
