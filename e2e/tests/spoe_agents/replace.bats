...
@test "Replace a spoe agent" {
    run dpa_curl PUT "/services/haproxy/spoe/spoe_agents/iprep-agent?spoe=spoefile_example2.cfg&version=1&scope=%5Bip-reputation%5D" /data/put.json
    assert_success
