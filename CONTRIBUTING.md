...
```
swagger generate server -f $GOPATH/src/github.com/haproxytech/dataplaneapi-specification/build/haproxy_spec.yaml \
    -A "Data Plane" \
...
swagger generate client -f $GOPATH/src/github.com/haproxytech/dataplaneapi-specification/build/haproxy_spec.yaml \
    -A "Data Plane" \
    -t $GOPATH/src/github.com/haproxytech/dataplaneapi \
    --existing-models github.com/haproxytech/models \
    --skip-models \
    --tags=Discovery \
    --tags=Information \
