...
// WithID adds the id to the get HTTP request rule params
func (o *GetHTTPRequestRuleParams) WithID(id int64) *GetHTTPRequestRuleParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get HTTP request rule params
func (o *GetHTTPRequestRuleParams) SetID(id int64) {
	o.ID = id
}
